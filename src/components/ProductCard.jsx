        ...
        {data.map((data) => (
          ...
          >
            ...
            <div className="leading-7">
              <h2 className="font-semibold text-neutral-400">{data.title}</h2>
              <h2 className="font-bold text-gray-500">${data.price}</h2>
            </div>
          </div>
        ))}
      </div>
