    ...
    <div className="min-h-[550px] flex justify-center items-center py-12">
      <div className="container mx-auto px-4">
        <div
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white grounded-3xl"
        >
          {/* cột thứ 1 */}
          ...
          <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
            ...
            <div data-aos="fade-up" data-aos-offset="0">
              <button
                ...
                className="bg-white py-2 px-4 rounded-full hover:scale-105 duration-300 cursor-pointer"
              >
                Shop Now
              </button>
            </div>
